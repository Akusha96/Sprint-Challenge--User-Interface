...
Semantic HTMl is meant to make the structure of the webpage more clear for source code reading.
Rather than writing <div> and <span>, and would write <form>,<table>,<article>
2. What are the 4 areas of the box model?
Margin,border,padding,content
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
he align-items property aligns flex items, that is, flex lines, just like justify-content, but in a perpendicular context.

4. Explain why git is valuable to a team of developers.
Gits a valuable for a team of developers because teams get to pick most relevant versions of code from each others commit.
That it allows my work to get out there in front of the public. 
5. Define mobile-first design in your own words.
Mobile-first design is a design targeted at mobile interaction first and dekstop interaction second.
